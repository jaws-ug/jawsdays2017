<?php
/**
 * JAWSDAYS 2016 functions and definitions.
 *
...
function jawsdays_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'jawsdays_custom_background_args', array(
...
function jawsdays_scripts() {
	...
	wp_enqueue_script(
		'jawsdays-script',
		get_stylesheet_directory_uri() . '/js/jawsdays-2016.js',
		array('jquery'),
		$jawsdays_theme_ver,
		true
	);
